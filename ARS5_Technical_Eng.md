...
::: {#tab:grammar}
  **Start symbol**   **Following symbols with probabilities**
  ...
  : Optimized transition probabilities (recalled from Section [\[sec:grammar\]](#sec:grammar){reference-type="ref" reference="sec:grammar"})
:::

# Implementation 1: DeepProbLog (Logic Programming)
...
``` {style="prolog" caption="ars5\\_deepproblog.pl"}
