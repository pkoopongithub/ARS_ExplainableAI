...
author:
- Paul Koop
date: Teaching and Learning Materials 2026
title: |
  **Between Interpretation and Computation**\
  Didactic Exploration of Computational Linguistics Methods\
  with Augmented Transcripts of Sales Conversations
---

# Introduction: Didactic Goals and Methodological Reflection
...
# The Eight Transcripts: Raw Data and Terminal Symbols
...
``` {caption="Transcript 1 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
Customer: Good day!
...
``` {caption="Transcript 2 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
``` {caption="Transcript 3 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
``` {caption="Transcript 4 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
``` {caption="Transcript 5 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
Customer 1: Goodbye!
...
``` {caption="Transcript 6 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
``` {caption="Transcript 7 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
``` {caption="Transcript 8 - Raw Data" basicstyle="\\ttfamily\\footnotesize"}
...
## The Terminal Symbol Strings (ARS 3.0)
...
# Scenario C: Computational Linguistics Integration
...
``` {.python caption="Data Augmentation for Teaching Purposes" language="Python"}
...
## Speech Act Recognition with Transformer Models

Automatic recognition of speech acts is performed with a fine-tuned BERT model:

``` {.python caption="Speech Act Recognition with BERT" language="Python"}
"""
...
``` {.python caption="Semantic Similarity with Word Embeddings" language="Python"}
"""
...
``` {.python caption="Topic Modeling with BERTopic" language="Python"}
"""
...
``` {.python caption="Rhetorical Structure Theory Parser" language="Python"}
"""
...
## Integration of Components in Scenario C

The complete integration of all components in Scenario C:

``` {.python caption="Scenario C - Complete Integration" language="Python"}
"""
...
## CRF for Sequential Dependencies

Conditional Random Fields model dependencies of speech acts on the wider context:

``` {.python caption="CRF for Sequential Dependencies" language="Python"}
"""
...
## Transformer Embeddings as Supplement

Transformer embeddings are used in addition to categorical terminal symbols:

``` {.python caption="Transformer Embeddings for Terminal Symbols" language="Python"}
"""
...
## Graph Neural Networks for the Nonterminal Hierarchy

The nonterminal hierarchy is modeled as a Graph Neural Network:

``` {.python caption="Graph Neural Network for Nonterminal Hierarchy" language="Python"}
"""
...
``` {.python caption="Attention Mechanisms for Sequence Modeling" language="Python"}
"""
...
## Integration of Components in Scenario D

The complete integration of all components in Scenario D:

``` {.python caption="Scenario D - Complete Hybrid Integration" language="Python"}
"""
Scenario D: Hybrid Modeling
...
# Comparison of Scenarios and Methodological Reflection
...
## Didactic Insights from Scenario C

The implementation of Scenario C has shown:

1.  **Need for large data volumes**: Neural methods require data volumes far exceeding the eight transcripts for valid results. Augmentation enables demonstration of functioning but does not replace real data.

2.  **Opacity of decisions**: Automatically learned categories and attention weights are not easily comprehensible to third parties. The XAI criteria of meaningfulness and transparency are violated.

3.  **Loss of interpretive basis**: Automatic speech act recognition does not capture the qualitatively meaningful distinctions of ARS (e.g., between KBA and KAA) but learns statistical correlations in vector space.

## Didactic Insights from Scenario D
